    ...
    static object HandleToolsList()
    {
        return new
        {
            tools = new object[]
            {
                ...
                new { name = "create_control", description = "Create a control on a form in design view. Supported control types include command_button, text_box, label, combo_box, list_box, check_box, option_button, option_group, toggle_button, subform, tab_control, image, line, and rectangle.", inputSchema = new { type = "object", properties = new { form_name = new { type = "string" }, control_type = new { type = "string", description = "Access control type, e.g. command_button, text_box, label, combo_box, or list_box." }, control_name = new { type = "string" }, section = new { type = "integer" }, parent_control_name = new { type = "string" }, column_name = new { type = "string" }, left = new { type = "integer" }, top = new { type = "integer" }, width = new { type = "integer" }, height = new { type = "integer" } }, required = new string[] { "form_name", "control_type" } } },
                new { name = "create_report_control", description = "Create a control on a report in design view. Supported control types include command_button, text_box, label, combo_box, list_box, check_box, option_button, option_group, toggle_button, subform, tab_control, image, line, and rectangle.", inputSchema = new { type = "object", properties = new { report_name = new { type = "string" }, control_type = new { type = "string", description = "Access control type, e.g. command_button, text_box, label, combo_box, or list_box." }, control_name = new { type = "string" }, section = new { type = "integer" }, parent_control_name = new { type = "string" }, column_name = new { type = "string" }, left = new { type = "integer" }, top = new { type = "integer" }, width = new { type = "integer" }, height = new { type = "integer" } }, required = new string[] { "report_name", "control_type" } } },
